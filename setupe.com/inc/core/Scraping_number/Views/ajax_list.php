            ...
            <div class="card b-r-10">
                <div class="card-body position-relative p-r-50">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="<?php _e( get_module_url("index/phone_numbers/".$value->ids) )?>" class="btn btn-sm btn-dark w-35 h-35 text-center d-flex align-items-center me-2 position-relative"><i class="position-absolute l-11 fs-14 fal fa-file-export"></i></a>
