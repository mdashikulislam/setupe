        ...
        <div class="">
            <div class="dropdown me-2">
                <div class="input-group sp-input-group border b-r-4">
                    ...
                    <a href="<?php _ec( get_module_url("popup_import_contact/".get_data($contact, "ids")) )?>" class="btn btn-light btn-active-light-primary actionItem border-end m-r-1" data-popup="ImportContactModal"><i class="fad fa-file-import"></i> <?php _e("Scraper Import")?></a>
