								...
								<div class="d-flex align-items-center flex-row-fluid flex-wrap">
									<div class="flex-grow-1 me-2 text-over-all">
										...
										<span class="text-muted fw-semibold d-block fs-12">
											...
											<span class="badge fw-4 fs-9 badge-light-<?php _ec( $login_type_color )?>"><?php _e( $login_type )?></span>
										</span>
										<?php if ($value->status == 0): ?>
										<a href="<?php _ec( base_url("instagram_profiles/oauth") )?>" class="text-danger fw-semibold d-block fs-12"><?php _e( "Re-login required" )?></a>
										<?php endif ?>
									</div>
								</div>
