	    	...
	    	<form class="actionForm" action="<?php _ec( get_module_url("save_twitter_api") ) ?>" method="POST">
		      	...
		      	<div class="modal-body p-25 shadow-none">
			        ...
			        <div class="mb-3">
		                ...
		                <input type="text" class="form-control form-control-solid" id="twitter_client_id" name="twitter_client_id" value="<?php _e( get_team_data("twitter_client_id", "") )?>">
		            </div>
		            <div class="mb-3">
		                <label for="twitter_client_secret" class="form-label"><?php _e('Twitter client secret')?></label>
		                <input type="text" class="form-control form-control-solid" id="twitter_client_secret" name="twitter_client_secret" value="<?php _e( get_team_data("twitter_client_secret", "") )?>">
		            </div>
		            <div class="mb-3">
		            ...
		            <div class="mb-3">
		                ...
		                <input type="text" class="form-control form-control-solid" id="twitter_bearer_token" name="twitter_bearer_token" value="<?php _e( get_team_data("twitter_bearer_token", "") )?>">
		            </div>
		      	</div>
