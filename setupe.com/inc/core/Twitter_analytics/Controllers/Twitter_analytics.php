...
class Twitter_analytics extends \CodeIgniter\Controller
{
    ...
    public function insights( $ids = false ) {
        ...
        return view( 'Core\Twitter_analytics\Views\insights', ["status" => "success", "stats" => $stats] );
