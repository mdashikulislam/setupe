    ...
    <div class="">
        <div class="dropdown me-2">
            <div class="input-group input-group-sm sp-input-group border b-r-4">
                ...
                <a href="<?php _ec( get_module_url("popup_add_rss") )?>" class="btn btn-light btn-active-light-primary actionItem" data-popup="addRssModal" title="<?php _e("Add new")?>" data-toggle="tooltip" data-placement="top"><i class="fad fa-plus text-primary pe-0"></i></a>
            </div>
        </div>
    </div>
</div>
