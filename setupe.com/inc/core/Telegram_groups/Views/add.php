    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-7">
                ...
                <div class="card mb-4 mb-xl-10">
                    <div class="card-header cursor-pointer">
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0"><i class="<?php _e( $config['icon'] )?>" style="color: <?php _e($config['color'])?>"></i> <?php _e("Add Telegram groups")?></h3>
                        </div>
                    </div>
            ...
            <div class="card mb-4 mb-xl-10">
                <div class="card-header cursor-pointer">
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0"><i class="fad fa-question-circle text-primary"></i> <?php _e("How to add groups")?></h3>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            <div class="flex-grow-1 me-2 text-over-all">
                                <?php _e("Add bot is an admin on your groups") ?>
                            </div>
                        </div>
                    </div>
                    <div class="separator separator-dashed my-4"></div>
                    <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                            <div class="flex-grow-1 me-2 text-over-all">
                                <?php _e("Send a message to groups as you want add") ?>
                            </div>
                        </div>
                    </div>
                    <div class="separator separator-dashed my-4"></div>
