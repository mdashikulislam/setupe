        ...
        <div class="row justify-content-center">
            <div class="col-lg-11 col-xl-10">
                ...
                <div class="inner-page-title">
                    <h2 class="s-52 w-700"><?php _e("Privacy Policy")?></h2>
                    <p class="p-lg"><?php _e("The information below provides details about our privacy policy and we ask that you take the time to read it.")?></p>
                </div>
