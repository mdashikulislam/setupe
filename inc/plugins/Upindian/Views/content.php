        ...
        <div class="row mb-4">
            <div class="col">
                <label class="border b-r-10 bg-white p-30 w-100 bg-hover-light-primary" for="bill_type_monthly">
                    ...
                    <div class="text-gray-500 fs-12"><?php _ec( get_option("payment_symbol", "$") )?><?php _e( sprintf("%s/month", 12) )?></div>
            ...
            <div class="col">
                <label class="border b-r-10 bg-white p-30 w-100 bg-hover-light-primary" for="bill_type_yearly">
                    ...
                    <div class="text-gray-500 fs-12"><?php _ec( get_option("payment_symbol", "$") )?><?php _e( sprintf("%s/year", 12) )?></div>
                </label>
            </div>
        </div>
