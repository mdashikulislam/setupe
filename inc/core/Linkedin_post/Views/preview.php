...
<div class="pv-body border rounded">
	<div class="preview-item preview-linkedin">
		
		<div class="pvi-header d-flex p-13">
			
			<div class="d-flex flex-stack">
				<div class="symbol symbol-45px me-3">
					<img src="<?php _ec( get_theme_url()."Assets/img/avatar.jpg" )?>" class="align-self-center" alt="">
				</div>
				<div class="d-flex align-items-center flex-row-fluid flex-wrap">
					<div class="flex-grow-1 me-2 text-over-all fs-12">
						...
						<span class="text-muted fw-semibold d-block fs-10"><?php _e("Sale manager")?></span>
						<span class="text-muted fw-semibold d-block fs-10"><?php _ec( date("M j") )?></span>
					</div>
				</div>
			</div>
		...
		<div class="pvi-footer border-top px-3 py-2">
			<div class="d-flex justify-content-between">
				...
				<div class="d-flex flex-stack">
					...
					<div class="d-flex align-items-center flex-row-fluid flex-wrap">
						<div class="flex-grow-1 me-2 text-over-all">
							<span class="text-gray-800 fs-12 fw-bold"><?php _e("Repost")?></span>
						</div>
					</div>
				</div>
				<div class="d-flex flex-stack">
					...
					<div class="d-flex align-items-center flex-row-fluid flex-wrap">
						<div class="flex-grow-1 me-2 text-over-all">
							<span class="text-gray-800 fs-12 fw-bold"><?php _e("Send")?></span>
						</div>
					</div>
				</div>
			</div>
