...
<div class="container d-sm-flex align-items-md-center pt-4 align-items-center justify-content-center">
    <div class="bd-search position-relative me-auto">
        <h2 class="mb-0 py-4"> <i class="<?php _ec( $config['menu']['sub_menu']['icon'] )?> me-2" style="color: <?php _ec( $config['menu']['sub_menu']['color'] )?>;"></i> <?php _e($config['menu']['sub_menu']['name'])?></h2>
    </div>
    <div class="">
