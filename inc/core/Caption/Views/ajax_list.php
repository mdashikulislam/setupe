<?php if ( !empty($result) ){ ?>
	<?php foreach ($result as $key => $value): ?>
		...
		<div class="col-md-4 col-sm-4 mb-4 caption-item">
		    <div class="card card-flush d-flex flex-column flex-row-auto  b-r-10 card-shadow position-relative">

		        <div class="card-header">
		        	<div class="d-flex w-100" style="justify-content: flex-start;gap: 10px;align-items: center">
                        <div class="text-primary fs-20  opacity-50 l-20">
                            <i class="fad fa-quote-left"></i>
                        </div>
		            	<h4 style="margin: 0" class="card-title fs-16 text-gray-800"><?php _e($value->title)?></h4>
...
<!--			            </div>-->
		        ...
		        <div class="card-body">
		        	<div style="padding-top: 20px" class="overflow-auto hide-x-scroll h-125 text-gray-600">
                ...
                <div style="padding: 20px">
                    <div class="d-flex justify-content-between">
                        <a class="actionItem" href="<?php _ec( get_module_url("index/update/".$value->ids) )?>"><i  class="fas fa-edit text-primary"></i> <?php _e("Edit")?></a>
                        <a href="<?php _ec( get_module_url("delete") )?>" class="actionItem" data-confirm="<?php _e("Are you sure to delete this items?")?>" data-remove="caption-item" data-id="<?php _ec( $value->ids )?>"><i  class="fas fa-trash-alt text-danger"></i> <?php _e("Delete")?></a>
                    </div>
                </div>
		    </div>            
		</div>
