                    ...
                    <div id="chat-messages">
                        <?php if (!empty($messages)): foreach ($messages as $message):?>
                            <div class="d-flex align-items-center justify-content-center text-muted small my-4">
                                <div class="width-1 height-1 bg-secondary rounded-circle opacity-25" data-tooltip="true" title="<?= $message->created_at ?>"></div>
                            </div>
                            <div class="d-flex my-4">
                                <div class="flex-shrink-0">
                                    <img src="" class="rounded-circle width-8 height-8 my-1 " data-tooltip="true" title="">
                                </div>
                                <div class="flex-grow-1">
                                    <div class="bg-base-2 px-3 rounded-lg d-flex">
                                        <div class="flex-grow-1 py-2 mb-n3">
                                            <?php
                                                echo convertToHtml($message->result);
                                            ?>
