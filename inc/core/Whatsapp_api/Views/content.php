    ...
    <div class="row">
        <div class="col-12">
            ...
            <table class="table table-striped table-borderless">
             ...
             <h6 class="border-bottom m-b-30 p-b-20 m-t-40 p-t-20" id="numberverification"><span class="text-success fw-6 m-r-5"><?php _e("POST") ?></span> <?php _e("Whatsapp Number Verification") ?></h6>
            <div class="alert alert-dark bg-gray-100 border-gray-500" role="alert" onclick='window.getSelection().selectAllChildren(this)'>
                <code class="text-gray-800 fs-12">
                    <?php _ec(base_url("api/number_verify?number=84933313xxx&instance_id=".  $account ."&access_token=" . get_team("ids"))) ?>
                </code>
            </div>

            <div class="text">
                <?php _e("Verification of Whatsapp Number on whatsapp Exits or Not") ?>
            </div>
