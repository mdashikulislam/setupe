...
<link href="<?=base_url()?>/inc/themes/backend/Stackmin/Assets/fonts/icomoon/icomoon.css" rel="stylesheet" type="text/css" />
		    ...
		    <div class="card-body">
    			...
    			<ul class="list-group mb-4">
				  	...
				  	<li class="border-bottom">
				  		<ul style="padding-left: 0" class=" mh-500 n-scroll no-update">
